...
namespace Gamekit3D
{
    ...
    public class PlayerController : MonoBehaviour, IMessageReceiver, IMagicEffects
    {
        ...
        private bool Electrocuted = false;
        ...
        public IEnumerator OnSlow(float duration, float slowRate)
        {
            ...
            Freezing = true;
            float originalMaxForwardSpeed = maxForwardSpeed;
            float originalJumpSpeed = jumpSpeed;
            float originalMinTurnSpeed = minTurnSpeed;
            float originalMaxTurnSpeed = maxTurnSpeed;

            maxForwardSpeed = maxForwardSpeed * slowRate;
            jumpSpeed = jumpSpeed * slowRate;
            minTurnSpeed = minTurnSpeed * slowRate;
            maxTurnSpeed = maxTurnSpeed * slowRate;

            yield return new WaitForSeconds(duration);

            maxForwardSpeed = originalMaxForwardSpeed;
            jumpSpeed = originalJumpSpeed;
            minTurnSpeed = originalMinTurnSpeed;
            maxTurnSpeed = originalMaxTurnSpeed;
            Freezing = false;
        }
