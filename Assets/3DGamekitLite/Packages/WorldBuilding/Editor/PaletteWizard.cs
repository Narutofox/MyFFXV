...
public class PaletteWizard : ScriptableWizard
{
    ...
    void OnWizardUpdate()
    {
        helpString = sourceImage == null ? "Select an TargetImage to generate a palette from." : "";
    ...
    {
        totalWork += 1;
        EditorUtility.DisplayProgressBar("Palette Wizard", "Calculating colors from TargetImage...", totalWork / totalWorkToComplete);
    }
